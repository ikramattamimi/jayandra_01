...
class ElectricityClassRegisterPage extends StatefulWidget {
  const ElectricityClassRegisterPage({super.key});

  @override
  State<ElectricityClassRegisterPage> createState() => _ElectricityClassRegisterPageState();
}

class _ElectricityClassRegisterPageState extends State<ElectricityClassRegisterPage> {
  var description =
