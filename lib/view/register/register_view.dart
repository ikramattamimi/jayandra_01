...
class RegisterElectricityClassView extends StatelessWidget {
  const RegisterElectricityClassView({super.key, required this.subtitle, required this.form, this.description, required this.title});
